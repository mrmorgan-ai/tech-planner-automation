...
from planify.adapters.driven.claude_code.dto import dump_proposal, parse_proposal
...
from planify.domain.model.planning_session import PlanningSession, SessionStatus
...
class JsonSessionRepository:
    root: Path = Path(".planify/sessions")
