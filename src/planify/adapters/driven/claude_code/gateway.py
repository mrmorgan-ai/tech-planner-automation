...
from planify.adapters.driven.claude_code.argv import build_launch, turn_text
...
from planify.adapters.driven.claude_code.stream_mapper import StreamMapper
...
class _system_prompt_file:
    ...
    def __enter__(self) -> Path:
        handle = tempfile.NamedTemporaryFile(
            mode="w", suffix=".md", prefix="planify-prompt-", delete=False, encoding="utf-8"
        )
        with handle:
